  ...
  $(document).on('change', '.select_type' ,function() {
    ...
    if(value_select_type == 'array') {
      ...
      // $(this).parents(".skema").find(".add_array").append("<a class='skema_add_field btn btn-primary' title='Add New Array' ><i class='fa fa-plus'></i></a>");
        ...
        $(this).parents(".skema").find(".skema2").remove()
        $(this).parents(".skema").find(".skema3").remove()
        $(this).parents(".skema").find(".array3").remove()
        $(this).parents(".skema").find(".form-baru-skema").remove()
        // console.log("wad")
    ...
    return s4() + s4();
          ...
          $(document).on('click', '.skema_add_field' ,function() {
            ...
            if(x < 21) {
              ...
              `;
              $(this).parents(".skema").find(".input_array").last().append(skema2); //add input box
